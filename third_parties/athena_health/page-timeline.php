...
<html lang="en">
	<head>
		...
		<link rel="canonical" href="http://<?= $host ?>/athenahealth/health-cares-big-shift/timeline.html">
		...
		<meta itemprop="image" content="http:<?= $asset_path ?>/img/social_timeline.jpg">
		...
		<meta name="twitter:image" content="http:<?= $asset_path ?>/img/social_timeline.jpg">

		<!-- Open Graph data -->
		<meta property="og:title" content="Paid Program: Health Care's Big Shift" />
		<meta property="og:type" content="article" />
		<meta property="og:url" content="http://<?= $host ?>/athenahealth/health-cares-big-shift/timeline.html" />
		<meta property="og:image" content="http:<?= $asset_path ?>/img/social_timeline.jpg" />
	...
	<body>
		<script>
	      var addthis_share = {
	        url: "http://<?= $host ?>/athenahealth/health-cares-big-shift/timeline.html",
